...
file_path_list = os.path.join(base_path + "/GameLists", 'steam_game_list3.json')
file_path_processed = os.path.join(base_path + "/Games", 'steam_games_processed_part7.json')
