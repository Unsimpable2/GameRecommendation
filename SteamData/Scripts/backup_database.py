...
def backup_database():
    source_file = '../MasterDeg/SteamData/SteamGames/Games/steam_games_processed_part3.json'
    backup_dir = '../MasterDeg/SteamData/SteamGames/Backup'
    backup_file = os.path.join(backup_dir, 'steam_games_processed_part3_backup.json')
