...
file_path_list = os.path.join(base_path + "/Data/IDList", 'steam_games_processed_part3_to_update.json')
file_path_processed = os.path.join(base_path + "/Data/GamesData", 'steam_games_processed_part3.json')
