...
file_path_list = os.path.join(base_path + "/Data/IDList", 'steam_games_processed_part4_to_update.json')
file_path_processed = os.path.join(base_path + "/Data/GamesData", 'steam_games_processed_part4.json')
